...
<script type="text/javascript" src="http://openapi.its.go.kr/javascript/openapi.accident.js"></script>
<script type="text/javascript">
	window.onload = init;
	var map;
	function init() {
		...
		// 사고정보 시작
		var accident = new Accident('accidentLayer');
		accident.getList();
		POPUP_LAYERS.push(accident.getLayer());
		// 사고정보 종료
