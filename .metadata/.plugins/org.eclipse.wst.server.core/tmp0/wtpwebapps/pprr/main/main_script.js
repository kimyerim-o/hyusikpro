...
var positions = [
    {
        content: '<div style="padding:5px;width:180px;text-align:center">서울 만남의 광장 부산</div>',
        latlng: new kakao.maps.LatLng(37.460379, 127.041943)
    },
    {
    	content: '<div style="padding:5px;width:180px;text-align:center">죽전휴게소 서울</div>',
        latlng: new kakao.maps.LatLng(37.332380, 127.104787)
    },
    {
    	content: '<div style="padding:5px;width:180px;text-align:center">기흥휴게소 부산</div>',
        latlng: new kakao.maps.LatLng(37.234963, 127.104573)
    },
    {
    	content: '<div style="padding:5px;width:180px;text-align:center">안성휴게소 서울</div>',
        latlng: new kakao.maps.LatLng(37.076830, 127.132447)
    },
        {
    	content: '<div style="padding:5px;width:180px;text-align:center">입장거봉포도휴게소 서울</div>',
        latlng: new kakao.maps.LatLng(36.942983, 127.192452)
    },
        {
    	content: '<div style="padding:5px;width:180px;text-align:center">망향휴게소 부산</div>',
        latlng: new kakao.maps.LatLng(36.855373, 127.180890)
    },
    	{
        content: '<div style="padding:5px;width:180px;text-align:center">천안삼거리휴게소 서울</div>',
        latlng: new kakao.maps.LatLng(36.787832, 127.173438)
    },
        {
        content: '<div style="padding:5px;width:180px;text-align:center">천안호두휴게소 부산</div>',
        latlng: new kakao.maps.LatLng(36.730251, 127.263871)
    },
        {
        content: '<div style="padding:5px;width:180px;text-align:center">청주휴게소 서울</div>',
        latlng: new kakao.maps.LatLng(36.716009, 127.349549),
    },
        {
    	content: '<div style="padding:5px;width:180px;text-align:center">옥산휴게소 부산</div>',
        latlng: new kakao.maps.LatLng(36.657951, 127.369754)
        
    },
        {
    	content: '<div style="padding:5px;width:180px;text-align:center">죽암휴게소 서울</div>',
        latlng: new kakao.maps.LatLng(36.496771, 127.430678)
    },
        {
        content: '<div style="padding:5px;width:180px;text-align:center">죽암휴게소 부산</div>',
        latlng: new kakao.maps.LatLng(36.486778, 127.429278)
    },
        {
        content: '<div style="padding:5px;width:180px;text-align:center">신탄진휴게소 서울</div>',
...
//var markerImage = new kakao.maps.MarkerImage(imageSrc, imageSize, imageOption),positions ; // 마커가 표시될 위치입니다
