...
<div id="d1">
 <br><br>
 <h2 align="center">휴~식 홈페이지 회원가입 페이지입니다. 환영합니다.</h2><br/><br/>
  <tr>
...
정보통신망법 규정에 따라 휴~식에 회원가입 신청하시는 분께 수집하는 개인정보의 항목, 개인정보의 수집 및 이용목적을 안내 드리오니 자세히 읽은 후 동의하여 주시기 바랍니다.
...
이용자는 회원가입을 하지 않은 상태에서 "게시물"작성과 기타 회원 서비스 외 정보 확인을 위한 데이터를 제공하며, 회원등록 시 최소한의 개인정보("이메일", "생년월일", "성별")를 수집하여 회원관리에 사용함을 명시합니다.
   ...
   <h3><a href="#"><font size="2">이벤트 등 프로모션 알림 메일 수신(선택)</font><input type="checkbox" name="c3" id="c3"/></a></h3>
   <div>
     <textarea readonly="readonly" rows="5" cols="66">

이벤트 등 프로모션 알림 메일 수신에 동의하시면, 이벤트를 활용한 광고 정보 수신 등을 포함하는 휴~식에서 제공하는 서비스를 이용할 수 있습니다.
